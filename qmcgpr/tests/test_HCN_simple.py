...
class TestRestartPredictions(unittest.TestCase, BenchmarkData, SystemData):
    ...
    def test_full_betafit(self):
        ...
        gpr = GPyDMQMC(
            ...
            y,
            self.beta_predict,
            restart_file='HCN/benchmark_betafit_full_domain.npy',
        )
    ...
    def test_full_tempfit(self):
        ...
        gpr = GPyDMQMC(
            ...
            y,
            self.temp_predict,
            restart_file='HCN/benchmark_tempfit_full_domain.npy',
        )
        self.assertTrue(self.compare_data[
    ...
    def test_sub_betafit(self):
        ...
        gpr = GPyDMQMC(
            ...
            y[mask],
            self.beta_predict,
            restart_file='HCN/benchmark_betafit_sub_domain.npy',
        )
        self.assertTrue(self.compare_data[
    ...
    def test_sub_tempfit(self):
        ...
        gpr = GPyDMQMC(
            ...
            y[mask],
            self.temp_predict,
            restart_file='HCN/benchmark_tempfit_sub_domain.npy',
        )
        self.assertTrue(self.compare_data[
