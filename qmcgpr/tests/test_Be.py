...
class BenchmarkData:
    ...
    def __init__(self) -> None:
        ...
        self.betafit_full = numpy.load(
            'Be/benchmark_betafit_full_domain.npy'
        )
        self.betafit_sub = numpy.load(
            'Be/benchmark_betafit_sub_domain.npy'
        )
        self.tempfit_full = numpy.load(
            'Be/benchmark_tempfit_full_domain.npy'
        )
        self.tempfit_sub = numpy.load(
            'Be/benchmark_tempfit_sub_domain.npy'
        )
...
class TestRestartGeneration(unittest.TestCase, BenchmarkData, SystemData):
    ...
    def doCleanups(self):
        ...
        if os.path.isfile('Be/betafit_full_domain.npy'):
            os.remove('Be/betafit_full_domain.npy')
        if os.path.isfile('Be/tempfit_full_domain.npy'):
            os.remove('Be/tempfit_full_domain.npy')
        if os.path.isfile('Be/betafit_sub_domain.npy'):
            os.remove('Be/betafit_sub_domain.npy')
        if os.path.isfile('Be/tempfit_sub_domain.npy'):
            os.remove('Be/tempfit_sub_domain.npy')
    ...
    def test_full_betafit(self):
        ...
        GPyDMQMC(
            ...
            y,
            self.beta,
            save_file='Be/betafit_full_domain.npy',
        )
        betafit_full = numpy.load('Be/betafit_full_domain.npy')
    ...
    def test_full_tempfit(self):
        ...
        GPyDMQMC(
            ...
            y,
            self.temp[1:],
            save_file='Be/tempfit_full_domain.npy',
        )
        tempfit_full = numpy.load('Be/tempfit_full_domain.npy')
    ...
    def test_sub_betafit(self):
        ...
        GPyDMQMC(
            ...
            y[mask],
            self.beta,
            save_file='Be/betafit_sub_domain.npy',
        )
        betafit_sub = numpy.load('Be/betafit_sub_domain.npy')
    ...
    def test_sub_tempfit(self):
        ...
        GPyDMQMC(
            ...
            y[mask],
            self.temp[1:],
            save_file='Be/tempfit_sub_domain.npy',
        )
        tempfit_sub = numpy.load('Be/tempfit_sub_domain.npy')
